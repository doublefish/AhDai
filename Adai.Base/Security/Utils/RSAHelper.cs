...
using Adai.Base.Security.Extensions;
using System;
using System.IO;
...
namespace Adai.Base.Security.Utils
{
	...
	public static class RSAHelper
	{
		...
		public static string DecryptByXml(string ciphertext, string key, StringType stringType = StringType.Base64, Encoding encode = null)
		{
			...
			{
				case StringType.Hex:
					bytes = Adai.Base.Utils.HexHelper.ToBytes(ciphertext);
		...
		public static bool VerifyByXml(string sign, string data, string publicKey, string hashName = HashHalg.MD5, StringType stringType = StringType.Base64, Encoding encode = null)
		{
			...
			{
				StringType.Hex => Adai.Base.Utils.HexHelper.ToBytes(sign),
				_ => Adai.Base.Utils.Base64Helper.ToBytes(sign),
			};
			using var rsa = new RSACryptoServiceProvider();
		...
		{
			var buffer = Adai.Base.Utils.Base64Helper.ToBytes(publicKey);
		...
		{
			var buffer = Adai.Base.Utils.Base64Helper.ToBytes(privateKey);
			if (buffer == null)
			{
