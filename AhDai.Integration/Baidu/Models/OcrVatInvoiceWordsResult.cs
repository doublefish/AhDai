...
/// <summary>
/// OcrVatInvoiceWordsResult
/// </summary>
public class OcrVatInvoiceWordsResult
{
    /// <summary>
    ...
    public OcrWordItemOutput[] CommodityName { get; set; } = default!;
    /// <summary>
    /// 规格型号
    /// </summary>

    [JsonPropertyName("CommodityType")]
    public OcrWordItemOutput[] CommodityType { get; set; } = default!;
    /// <summary>
    /// 单位
    /// </summary>
    [JsonPropertyName("CommodityUnit")]
    public OcrWordItemOutput[] CommodityUnit { get; set; } = default!;
    /// <summary>
    /// 数量
    /// </summary>
    [JsonPropertyName("CommodityNum")]
    public OcrWordItemOutput[] CommodityNum { get; set; } = default!;
    /// <summary>
    /// 单价
    /// </summary>
    [JsonPropertyName("CommodityPrice")]
    public OcrWordItemOutput[] CommodityPrice { get; set; } = default!;
    /// <summary>
    /// 金额
    /// </summary>
    [JsonPropertyName("CommodityAmount")]
    public OcrWordItemOutput[] CommodityAmount { get; set; } = default!;
    /// <summary>
    /// 税率
    /// </summary>
    [JsonPropertyName("CommodityTaxRate")]
    public OcrWordItemOutput[] CommodityTaxRate { get; set; } = default!;
    /// <summary>
    /// 税额
    /// </summary>
    [JsonPropertyName("CommodityTax")]
    public OcrWordItemOutput[] CommodityTax { get; set; } = default!;
    /// <summary>
