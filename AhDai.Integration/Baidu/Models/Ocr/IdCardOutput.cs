...
/// IdCardOutput
/// </summary>
public class IdCardOutput : BaseOutput<Dictionary<string, CardWordsResult>>
{
    /// <summary>
    ...
    public IdCardQualityOutput? CardQuality { get; set; }
    /// <summary>
    ...
    public LocationOutput? PhotoLocation { get; set; }
    /// <summary>
    ...
    public LocationOutput? CardLocation { get; set; }
    /// <summary>
