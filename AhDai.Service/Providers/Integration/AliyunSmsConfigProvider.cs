...
[Attributes.Service]
internal class AliyunSmsConfigProvider(IConfiguration configuration, IParameterService parameterService)
    : BaseIntegrationConfigProvider<AliyunSmsConfig>(configuration, parameterService)
