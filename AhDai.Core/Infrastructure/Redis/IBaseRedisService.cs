...
public interface IBaseRedisService
{
    ...
    /// <returns></returns>
    string CreateConfiguration(RedisOptions? options = null);
    ...
    /// <param name="options">自定义配置</param>
    /// <returns></returns>
    IConnectionMultiplexer CreateConnection(RedisOptions? options = null);
    ...
    /// <param name="options">自定义配置</param>
    /// <returns></returns>
    IConnectionMultiplexer GetConnection(RedisOptions? options = null);
    ...
    /// <param name="options">自定义配置</param>
    /// <returns></returns>
    IDatabase GetDatabase(int db = -1, object? asyncState = null, RedisOptions? options = null);
}
