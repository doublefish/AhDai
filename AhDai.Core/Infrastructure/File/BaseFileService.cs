...
public class BaseFileService(IOptionsMonitor<FileOptions> options, IHttpClientFactory? httpClientFactory) : IBaseFileService
{
    readonly IOptionsMonitor<FileOptions> _options = options;
