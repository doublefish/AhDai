...
namespace Adai.Standard.Utils
{
	...
	public static class RedisHelper
	{
		...
		/// Configuration
		/// </summary>
		public static Models.RedisConfig Configuration { get; private set; }

		/// <summary>
		/// 初始化
		/// </summary>
		/// <param name="configuration"></param>
		public static void Init(Models.RedisConfig configuration)
		{
		...
		/// <param name="configuration"></param>
		/// <returns></returns>
		public static IDatabase GetDatabase(Models.RedisConfig configuration = null)
		{
		...
		/// <param name="configuration"></param>
		/// <returns></returns>
		public static IConnectionMultiplexer GetConnectionMultiplexer(Models.RedisConfig configuration = null)
		{
